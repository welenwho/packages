...
TEST_ROOT='/tmp/sbproxy-adaptive-fast-failure-test'
...
printf '%s\n' \
	'ERROR stale: open connection to stale.example:443 using outbound/direct[sbproxy-adaptive-final-direct-out]: failed' \
	>"$CORE_LOG"
...
EOF
printf '%s\n' '{"delay":200}' >"$API_DIR/proxies/sbproxy-adaptive-out/delay"
