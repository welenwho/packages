...
printf '%s\n' "$tailscale_form" | grep -Fq "subnetRouteOption.value(route.route, route.route)"
printf '%s\n' "$tailscale_form" | grep -Fq "advertiseRouteOption.value(route.value, route.value)"
printf '%s\n' "$tailscale_form" | grep -Fq "subnetRouteOption.value('-', _('Loading'))"
printf '%s\n' "$tailscale_form" | grep -Fq "advertiseRouteOption.value('-', _('Loading'))"
printf '%s\n' "$tailscale_form" | grep -Fq "widget.addChoices(values, labels)"
