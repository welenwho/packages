...
| `luci-app-sbproxy` | `1.0.1-r2` | sing-box 代理与 VPN 平台，支持可选的内置 Tailscale。 | [welenwho/packages](https://github.com/welenwho/packages) |
...
| 软件包 | 版本 | 源码来源 |
| --- | --- | --- |
| `axonhub` | `20260908-r1` | [VIKINGYFY/packages](https://github.com/VIKINGYFY/packages) |
