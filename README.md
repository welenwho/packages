...
| `luci-app-sbproxy` | `1.0.1-r18` | sing-box 代理与 VPN 平台，支持可选的内置 Tailscale。 | [welenwho/packages](https://github.com/welenwho/packages) |
...
| `sing-box` | `1.14.2-r1` | [SagerNet/sing-box](https://github.com/SagerNet/sing-box) |
